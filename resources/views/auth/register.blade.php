 ...
 .form{
  ...
  <div class="w-full max-w-xs bg-blue-800 form mt-4"> 
    <form action="{{ route('register.save') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ">
      ...
      <input type="submit" value="Register" class=" ml-20 bg-blue-600 px-3 py-2  text-white hover:bg-blue-900 ">
      <div class="pt-2 hover:text-indigo-800"><a href="login"><button>Already have an account?</button></a></div>
    </form>
    </div>
@endsection