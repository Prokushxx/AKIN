...
<section class="header">
  <nav>
      ...
      <div class="nav-links" id="navLinks">
         ...
         @auth   
         <div class="text-white"><a href="{{route('update.show',auth()->user()->id)}}">{{ Session('user') }}</a></div>
         @endauth
          <ul>
              @auth()
              ...
              <li><div>
                <button onclick="openModal('main-modal')" class='text-white font-medium'>Contact Us</button>
              </div>  </li>
              <li><a href="{{ route('logout') }}" onclick="log()" id="logout">LOG OUT</a></li>
              @endif
              @else
